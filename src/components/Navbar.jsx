        ...
        <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
          ...
          <Flex display={{ base: 'none', md: 'flex' }} ml={10}>
            <InputGroup>
              ...
              <Input className='Input' variant='filled' placeholder='Search' />
            </InputGroup>
